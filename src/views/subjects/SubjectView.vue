    ...
    <v-card>
      <v-responsive>
        <v-data-table-server
          ...
          :headers="headers"
          :items="subjects"
          :style="{ width: '2000px', padding: '50px' }"
                    ...
                    <v-form ref="refForm">
                      <v-container>
                        <v-row>
                          <v-col cols="12">
                            <v-text-field
                              v-model="subjectStore.editedSubject.id"
                          ...
                          <v-col cols="12">
                            <v-text-field
                              v-model="subjectStore.editedSubject.thaiName"
                              :rules="[(v) => !!v || 'Field is required']"
                              label=" ชื่อรายวิชา"
                            ></v-text-field>
                          </v-col>
                          <v-col cols="12">
                            <v-text-field
                              v-model="subjectStore.editedSubject.engName"
                              :rules="[(v) => !!v || 'Field is required']"
                          ...
                          <v-col cols="6">
                            <v-text-field
                              v-model.number="subjectStore.editedSubject.credit"
                              :rules="[(v) => !!v || 'Field is required']"
                              label="หน่วยกิต"
                            ></v-text-field>
                          </v-col>
                          <v-col cols="6">
                            <v-text-field
                              v-model="subjectStore.editedSubject.studyTime"
                              :rules="[(v) => !!v || 'Field is required']"
                          ...
                          <v-col cols="12">
                            <v-textarea
                              v-model="subjectStore.editedSubject.description"
                              :rules="[(v) => !!v || 'Field is required']"
